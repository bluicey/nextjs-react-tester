...
const rows = [
  ...
  [
    { key: 'ControlLeft', label: 'Control' },
    { key: 'AltLeft', label: 'Option' },
    { key: 'MetaLeft', label: 'Command' },
    { key: 'Space', label: 'Space', className: 'flex-grow' },
    { key: 'MetaRight', label: 'Command' },
    { key: 'AltRight', label: 'Option' },
    { key: 'ArrowLeft', label: '←' },
    { key: 'ArrowUp', label: '↑' },
    { key: 'ArrowDown', label: '↓' },
